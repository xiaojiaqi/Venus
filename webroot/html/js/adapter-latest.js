...
module.exports = function(window, edgeVersion) {
  ...
  RTCPeerConnection.prototype.removeTrack = function(sender) {
    ...
    if (!transceiver) {
      throw makeError('InvalidAccessError',
          'Sender was not created by this websocketsignallingconnection.');
    }
  ...
  // Update the ice websocketsignallingconnection state.
  ...
  // Update the websocketsignallingconnection state.
...
module.exports = {
  ...
  shimAddTrackRemoveTrack: function(window) {
    ...
    window.RTCPeerConnection.prototype.removeTrack = function(sender) {
      ...
      if (!isLocal) {
        throw new DOMException('Sender was not created by this websocketsignallingconnection.',
            'InvalidAccessError');
      }
